     ...
     ->group(function () {
         Route::get('dashboard', [AdminDashboardController::class, 'index'])->name('dashboard');
          ...
          ->group(function () {
               ...
               Route::prefix('infra-audit')
                    ->name('infra-audit.')
                    ->group(function () {
                         Route::get('/', [AdminInfrastructureAuditController::class, 'index'])->name('index');
                         Route::get('/{id}',    [AdminInfrastructureAuditController::class, 'show']) ->name('show');
               });
          });
     });
     ...
     ->group(function () {
          ...
          ->group(function () {
               ...
               Route::prefix('infra-audit')
                    ->name('infra-audit.')
                    ->group(function () {
                         Route::get('/', [InfrastructureAuditController::class,'index'])->name('index');
                         Route::get('/create', [InfrastructureAuditController::class,'create'])->name('create');
                         Route::post('/infra-audit/store', [InfrastructureAuditController::class,'store'])->name('store');
                         Route::post  ('verify-banner',        [InfrastructureAuditController::class, 'verifyBanner'])
                         ->name('verify-banner');
                         Route::get( '/show/{id}',      [InfrastructureAuditController::class, 'show'])  ->name('show');
               });
