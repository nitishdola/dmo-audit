    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
            ...
            .right-panel { padding: 24px 20px 20px; justify-content: flex-start; }
    ...
    <main class="main">
        ...
        <div class="left-panel">
            <div class="panel-content">
                ...
                <div class="notice-list">
                    ...
                    <div class="notice-item"><i class="fas fa-user-shield"></i><span>District Medical Officer under Atal Amrit Abhiyan Society personnel only.</div>
                </div>
            </div>
        </div>
        ...
        <div class="right-panel">
            ...
            <div class="security-note">
                ...
                <span>Your session is secured end-to-end. This portal is for authorised District Medical Officer under Atal Amrit Abhiyan Society personnel only.</span></span>
            </div>
        </div>
    </main>
